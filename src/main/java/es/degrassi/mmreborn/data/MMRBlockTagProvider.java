...
public class MMRBlockTagProvider extends BlockTagsProvider {
  ...
  protected void addTags(HolderLookup.@NotNull Provider provider) {
    tag(MMRTags.Blocks.ENERGY_INPUT).add(
    ...
    tag(MMRTags.Blocks.ENERGY_OUTPUT).add(
    ...
    tag(MMRTags.Blocks.FLUID_INPUT).add(
    ...
    tag(MMRTags.Blocks.FLUID_OUTPUT).add(
    ...
    tag(MMRTags.Blocks.OUTPUT_BUS).add(
    ...
    tag(MMRTags.Blocks.CASINGS).add(
