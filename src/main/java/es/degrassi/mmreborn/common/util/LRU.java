...
/**
 * Taken from <a
 * href="https://github.com/mekanism/Mekanism/blob/release/1.20.x/src/main/java/mekanism/common/lib/collection/LRU.java">mekanism
 * lib</a>
 */
public class LRU<T> extends AbstractCollection<T> {
  ...
  private static class LRUEntry<T> {
    ...
    private LRUEntry(@Nullable T value) {
      this.value = value;
    }
  }
