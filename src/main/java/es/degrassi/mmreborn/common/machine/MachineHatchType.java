...
public enum MachineHatchType implements StringRepresentable, IExtensibleEnum {
  ...
  CONSUME_DURABILITY_HATCH_TINY,
  CONSUME_DURABILITY_HATCH_SMALL,
  CONSUME_DURABILITY_HATCH_NORMAL,
  CONSUME_DURABILITY_HATCH_BIG,

  REPAIR_DURABILITY_HATCH_TINY,
  REPAIR_DURABILITY_HATCH_SMALL,
  REPAIR_DURABILITY_HATCH_NORMAL,
  REPAIR_DURABILITY_HATCH_BIG
  ;
