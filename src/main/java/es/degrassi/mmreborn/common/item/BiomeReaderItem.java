...
public class BiomeReaderItem extends ItemBlockMachineComponent implements ItemHatch {
  private static final ResourceLocation BASE_TEXTURE = ModularMachineryReborn.rl("block/casing_plain");
  private static final ResourceLocation OVERLAY_TEXTURE = ModularMachineryReborn.rl("block/overlay_biome_reader");
  public BiomeReaderItem(BlockBiomeReader block) {
    super(
        block,
        new Properties()
            ...
            .component(DataComponentRegistration.DEFAULT_MODEL, ModularMachineryReborn.rl("default/hatches/biome_reader"))
    );
  }
