...
@Getter
public class OutputBusItem extends ItemBlockMachineComponent implements ItemHatch {
  ...
  public OutputBusItem(BlockOutputBus block, ItemBusSize type) {
    super(
        ...
        new Properties()
            ...
            .component(DataComponentRegistration.OVERLAY_TEXTURE, ModularMachineryReborn.rl("block/overlay_outputbus_" + type.getSerializedName()))
            .component(DataComponentRegistration.DEFAULT_MODEL, ModularMachineryReborn.rl("default/hatches/outputbus_" + type.getSerializedName()))
    );
    this.type = type;
  }
  ...
  public ResourceLocation getDefaultOverlayTexture() {
    return ModularMachineryReborn.rl("block/overlay_outputbus_" + type.getSerializedName());
  }
}
