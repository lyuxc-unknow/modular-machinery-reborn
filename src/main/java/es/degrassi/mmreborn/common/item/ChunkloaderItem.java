...
public class ChunkloaderItem extends ItemBlockMachineComponent implements ItemHatch {
  private static final ResourceLocation BASE_TEXTURE = ModularMachineryReborn.rl("block/casing_plain");
  private static final ResourceLocation OVERLAY_TEXTURE = ModularMachineryReborn.rl("block/overlay_chunkloader");

  public ChunkloaderItem(BlockChunkloader block) {
    super(block,
        new Properties()
            ...
            .component(DataComponentRegistration.DEFAULT_MODEL, ModularMachineryReborn.rl("default/hatches/chunkloader"))
    );
  }
